...
public:
  ...
  virtual void draw(DrawingContext& context, const Vector& pos, float size) override;
  virtual void draw(DrawingContext& context, const Vector& pos, int pixels_shown) override;
  virtual void draw(DrawingContext& context, const Vector& pos, int pixels_shown, float size) override;
