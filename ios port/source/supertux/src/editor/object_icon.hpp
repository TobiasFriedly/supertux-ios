...
public:
  ...
  virtual void draw(DrawingContext& context, const Vector& pos, float size);
  virtual void draw(DrawingContext& context, const Vector& pos, int pixels_shown);
  virtual void draw(DrawingContext& context, const Vector& pos, int pixels_shown, float size);
