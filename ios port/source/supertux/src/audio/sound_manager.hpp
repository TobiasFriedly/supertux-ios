...
public:
  ...
  void play_music(const std::string& filename, float fadetime, bool looping);
  ...
  bool seek_music(double seconds);
  double get_music_position() const;
  double get_music_duration() const;
  bool is_music_finished() const;
  void recover_audio_context();
